...
A single-page portfolio site built from my resume. Plain HTML/CSS/JS — no build step, no dependencies.

## Files

- `index.html` — page content
- `styles.css` — all styling
- `script.js` — small entrance animation on the hero (skips itself if the visitor prefers reduced motion)
